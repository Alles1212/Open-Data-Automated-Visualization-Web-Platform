window.onload = (function() {
    ...
    function suspendBox(d){
        ...
        suBox.style.left = d.pageX - 230 + 'px';
        suBox.style.visibility = 'visible'; // 顯示懸浮框
        suBox.style.zIndex = 1;
    ...
    var changeBtnForRight = document.getElementById('changeBtnForRight'); 
    var changeBtnForLeft = document.getElementById('changeBtnForLeft');
    ...
    var checkWhichChartsCalled = document.getElementById("checkWhichChartsCalled").textContent;
